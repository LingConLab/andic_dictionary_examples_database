...
You can download raw data as [.csv](https://raw.githubusercontent.com/LingConLab/andic_dictionary_examples_database/refs/heads/main/andic_examples.csv) or [.xlsx](https://raw.githubusercontent.com/LingConLab/andic_dictionary_examples_database/refs/heads/main/andic_examples.xlsx).
...
```{r}
db %>% 
  reactable(filterable = TRUE, minRows = 15)
```
